...
/**
 * As duas trilhas dos materiais, com o que cada uma reune. Enquanto nao ha
 * material publicado, a trilha e uma descricao, nao um filtro. A cor da regua
 * e a mesma do chip de trilha no cartao de cada material.
 */
